...
def createSettingSummary(prompt, response1, response2, response3):
    return "The user just said \n" + prompt + "\n. Your response(s) prior to the user's input were \n" + response1 + ", " + response2 + ", " + response3 + ".\n Please describe the environment of this interaction based on the context in a series of randomly-determined contextually based comma-separated keywords and artistic stylings. Be sure to play up the drama and down-play joy/calm."
